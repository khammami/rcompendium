...
To create a new compendium structure, run `rcompendium::create_new_compendium()`.
...
The default structure created by `rcompendium::create_new_compendium()` is a good 
...
`rcompendium::create_new_compendium()` or call the function `rcompendium::add_renv()` 
after `rcompendium::create_new_compendium()`.
...
`rcompendium::create_new_compendium()` or call the function `rcompendium::add_dockerfile()` 
after `rcompendium::create_new_compendium()`. 
